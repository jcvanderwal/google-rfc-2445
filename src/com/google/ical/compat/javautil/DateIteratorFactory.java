...
public class DateIteratorFactory {
    ...
    public static DateIterator createDateIterator(String rdata, Date start, TimeZone tzid, boolean strict) throws ParseException {
        return new RecurrenceIteratorWrapper(RecurrenceIteratorFactory.createRecurrenceIterator(rdata, dateToDateValue(start, true), tzid, strict));
    }
    
    public static DateIterator createDateIterator(Recurrence rdata, Date start, TimeZone tzid, boolean strict) throws ParseException {
        return new RecurrenceIteratorWrapper(RecurrenceIteratorFactory.createRecurrenceIterator(rdata, dateToDateValue(start, true), tzid, strict));
    }
    ...
    public static DateIterable createDateIterable(Recurrence rdata, Date start, TimeZone tzid, boolean strict) throws ParseException {
        return new RecurrenceIterableWrapper(RecurrenceIteratorFactory.createRecurrenceIterable(rdata, dateToDateValue(start, true), tzid, strict));
    }
