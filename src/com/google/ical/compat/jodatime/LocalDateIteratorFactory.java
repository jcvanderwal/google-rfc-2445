...
public class LocalDateIteratorFactory {
     ...
     * @param tzid the local timezone -- used to interpret any dates in RDATE
     *            and EXDATE lines that don't have TZID params.
    ...
    public static LocalDateIterator createLocalDateIterator(String rdata, LocalDate start, DateTimeZone tzid, boolean strict) throws ParseException {
        return new RecurrenceIteratorWrapper(RecurrenceIteratorFactory.createRecurrenceIterator(rdata, localDateToDateValue(start), TimeZoneConverter.toTimeZone(tzid), strict));
    }
    
    public static LocalDateIterator createLocalDateIterator(Recurrence rdata, LocalDate start, DateTimeZone tzid, boolean strict) throws ParseException {
        return new RecurrenceIteratorWrapper(RecurrenceIteratorFactory.createRecurrenceIterator(rdata, localDateToDateValue(start), TimeZoneConverter.toTimeZone(tzid), strict));
    }
    ...
    public static LocalDateIterator createLocalDateIterator(Recurrence rdata, LocalDate start, boolean strict) throws ParseException {
        return createLocalDateIterator(rdata, start, DateTimeZone.UTC, strict);
    }
    ...
    public static LocalDateIterable createLocalDateIterable(String rdata, LocalDate start, DateTimeZone tzid, boolean strict) throws ParseException {
        return new RecurrenceIterableWrapper(RecurrenceIteratorFactory.createRecurrenceIterable(rdata, localDateToDateValue(start), TimeZoneConverter.toTimeZone(tzid), strict));
    }

    public static LocalDateIterable createLocalDateIterable(Recurrence rdata, LocalDate start, DateTimeZone tzid, boolean strict) throws ParseException {
        return new RecurrenceIterableWrapper(RecurrenceIteratorFactory.createRecurrenceIterable(rdata, localDateToDateValue(start), TimeZoneConverter.toTimeZone(tzid), strict));
    }
    /**
     * given a block of RRULE, EXRULE, RDATE, and EXDATE content lines, parse
    ...
    public static LocalDateIterable createLocalDateIterable(Recurrence rdata, LocalDate start, boolean strict) throws ParseException {
        return createLocalDateIterable(rdata, start, DateTimeZone.UTC, strict);
    }
